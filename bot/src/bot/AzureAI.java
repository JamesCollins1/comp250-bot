 ...
 * @author santi
 */
public class AzureAI extends AIWithComputationBudget implements InterruptibleAI {
    ...
    public AzureAI(UnitTypeTable utt) {
        this(100,-1,100,10,
             new MikasaAI(utt),
    ...
    public AzureAI(int available_time, int max_playouts, int lookahead, int max_depth, AI policy, EvaluationFunction a_ef) {
    ...
    public AI clone() {
        return new AzureAI(TIME_BUDGET, ITERATIONS_BUDGET, MAXSIMULATIONTIME, MAX_TREE_DEPTH, randomAI, ef);
    }  
